...
function getNextPageSlugForRedirect() {
  const normalize = (value) => {
    if (!value) return "";
    return value.startsWith("/6a0b42707f4c8c35affcaceb-preview") ? value : (value.startsWith("/") ? "/6a0b42707f4c8c35affcaceb-preview" + value : "/6a0b42707f4c8c35affcaceb-preview/" + value);
  };
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const endpoint =
    ...
    `&with=order_offers,customer_address_billing,customer_address_shipping,customer,transactions,cart&pageId=HTlCqMu1Ai_WFbnfbwyjD4X90D3xM_QwNf3UDkHlFNeBW26pMymeyKGVFBokmqr2`
